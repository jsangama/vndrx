...
const ZONES_ASWA = [
  { id: "morales", name: "Morales", address: "Delivery local", cost: 3, emoji: "📍" },
  { id: "tarapoto", name: "Tarapoto", address: "Entrega urbana", cost: 4, emoji: "📍" },
  { id: "banda", name: "Banda", address: "Banda de Shilcayo", cost: 5, emoji: "📍" },
  { id: "recojo", name: "Recojo", address: "Sin delivery", cost: 0, emoji: "🏭" },
  { id: "nacional", name: "Nacional", address: "ASWA lleva tu pedido hasta agencia. El flete destino lo pagas al recoger.", cost: 10, emoji: "🚌" },
];
...
const products = [
  ...
  {
    id: 15,
    name: "Chicha ASWA 400 ml",
    subtitle: "La Rica Chicha · Presentacion personal",
    line: "chicha",
    supplier: "ASWA La Rica Chicha",
    img: "🌽",
    desc: "Ideal para consumo personal. Disponible desde 1 unidad. Chicha artesanal hecha con maiz San Martinense de la selva peruana.",
    quality: "Artesanal · 100% natural",
    variety: "Maíz San Martinense",
    tags: ["400 ml", "Consumo personal", "100% natural", "Desde 1 unidad"],
    minOrder: 1,
    minOrderNote: "Disponible desde 1 unidad",
    schoolOnly: false,
    ...
    tip: "Delivery: precio del producto mas delivery segun distrito: Morales S/ 3.00, Tarapoto S/ 4.00 y Banda de Shilcayo S/ 5.00.",
    zones: ZONES_ASWA,
  },
  {
    id: 901,
    name: "Chicha ASWA 2 litros",
    subtitle: "Presentacion practica para casa",
    line: "chicha",
    supplier: "ASWA La Rica Chicha",
    img: "🌽",
    desc: "Presentacion practica para casa. Ideal para compartir durante el dia y mantener refrigerada.",
    quality: "Artesanal · 100% natural",
    variety: "Maíz San Martinense",
    tags: ["2 litros", "Para casa", "100% natural", "Desde 1 unidad"],
    minOrder: 1,
    minOrderNote: "Disponible desde 1 unidad",
    schoolOnly: false,
    defaultZoneId: "morales",
    ...
    saving: 0,
    cooking: "Consumir fria · Refrigerar antes del consumo",
    tip: "Delivery por zona: Morales S/ 3.00, Tarapoto S/ 4.00, Banda S/ 5.00, recojo S/ 0.00.",
    zones: ZONES_ASWA,
  },
  {
    id: 902,
    name: "Chicha ASWA 3 litros",
    subtitle: "Ideal para compartir en familia",
    line: "chicha",
    supplier: "ASWA La Rica Chicha",
    img: "🌽",
    desc: "Ideal para compartir en familia. Una presentacion rendidora para almuerzos, visitas y reuniones pequenas.",
    quality: "Artesanal · 100% natural",
    variety: "Maíz San Martinense",
    tags: ["3 litros", "Familiar", "100% natural", "Desde 1 unidad"],
    minOrder: 1,
    minOrderNote: "Disponible desde 1 unidad",
    schoolOnly: false,
    defaultZoneId: "morales",
  ...
  {
    id: 903,
    name: "Chicha ASWA 4 litros",
    subtitle: "Galon familiar para almuerzo o reunion",
    line: "chicha",
    supplier: "ASWA La Rica Chicha",
    img: "🌽",
    desc: "Galon familiar para almuerzo o reunion. Pensado para compartir en casa con un precio directo y claro.",
    quality: "Artesanal · 100% natural",
    variety: "Maíz San Martinense",
    tags: ["4 litros", "Galon familiar", "100% natural", "Desde 1 unidad"],
    minOrder: 1,
    minOrderNote: "Disponible desde 1 unidad",
    schoolOnly: false,
    defaultZoneId: "morales",
    presentations: [
      { label: "Galon 4 L", price: 15.00, unit: "galon" },
    ],
    saving: 0,
    cooking: "Consumir fria · Refrigerar antes del consumo",
    tip: "Delivery por zona: Morales S/ 3.00, Tarapoto S/ 4.00, Banda S/ 5.00, recojo S/ 0.00.",
  ...
  },
  {
    id: 16,
    name: "Bidon ASWA 20L",
    subtitle: "Recarga retornable o bidon nuevo",
    line: "chicha",
    supplier: "ASWA La Rica Chicha",
    img: "🪣",
    desc: "Recarga retornable: entrega tu bidon vacio al recibir. Tambien puedes pedir bidon nuevo con envase retornable.",
    quality: "Artesanal · Bidon retornable 20L",
    variety: "Maíz San Martinense",
    tags: ["20 litros", "Recarga S/ 60", "Bidon nuevo S/ 80", "Desde 1 unidad"],
    minOrder: 1,
    minOrderNote: "Sin pedido minimo — desde 1 bidon",
    schoolOnly: false,
    defaultZoneId: "morales",
    presentations: [
      { label: "Recargar · ya tengo bidon vacio", price: 60.00, unit: "bidon" },
      { label: "Bidon nuevo · chicha + envase retornable", price: 80.00, unit: "bidon" },
    ],
    saving: 15,
    cooking: "Consumir fría · Gran capacidad para fiestas y eventos",
    tip: "Ahorro por recarga: en recarga de bidon 20L pagas S/ 60 y ahorras S/ 15, equivalente a una presentacion familiar de 4L.",
    zones: ZONES_ASWA,
  },
  {
    id: 17,
...
const COMPANY_VIEWS = {
  ...
  aswa: {
    ...
    name: "ASWA La Rica Chicha",
    shortName: "ASWA",
    tagline: "Chicha, bidon 20L y presentaciones familiares",
    description: "Elige ASWA para comprar chicha 400 ml, 2L, 3L, 4L, bidon 20L y promociones escolares en una tienda separada.",
    heroTitle: "ASWA para pedidos rapidos",
    heroText: "Chicha personal, familiar y bidon 20L con fotos reales, total por zona y pedido directo por WhatsApp.",
    heroChips: ["400 ml", "2L, 3L y 4L", "Bidon 20L"],
    heroImage: ASSETS.aswaLogo,
    heroNote: "SAN JUAN 2026",
    infoTitle: "ASWA La Rica Chicha",
    infoBody: "La Rica Chicha para consumo personal, familias, colegios, eventos y pedidos de temporada. El cliente elige producto y zona para ver el total real antes de pedir.",
    companyPhone: SUPPLIERS.aswa.displayPhone,
    companyContact: "Pedidos de chicha y bidon",
...
const ASWA_PROMO_LIBRARY = [
  ...
  },
  {
    ...
    accent: "#F0C040",
    featured: true,
    message: "Bidon sanjuanero ASWA de 20 litros desde S/ 60.00 con recarga y S/ 80.00 con bidon nuevo. Pedidos al 955 273 229.",
  },
  {
    id: "combo-escolar",
  ...
  },
  {
    ...
    accent: "#FDBA74",
    featured: false,
    message: "Bidon sanjuanero 20L ASWA edicion 2026. Recarga S/ 60 o bidon nuevo S/ 80. Pide por WhatsApp al 955 273 229.",
  },
];
...
function CompanyChooserScreen({ onChooseCompany, onInstallApp, toastBubble, visibleCompanyKeys = Object.keys(COMPANY_VIEWS) }) {
  ...
  const options = [
    ...
    },
    {
      ...
      accent: HOME.leaf,
      chips: ["400 ml", "2L-4L", "Bidon 20L"],
      note: "San Juan 2026",
      description: "Entra a ASWA para ver chicha 400 ml, 2L, 3L, 4L, bidon 20L y promos escolares en una tienda separada.",
